                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button wire:click="destroy({{ $post->id }})" wire:confirm="Apakah Anda Yakit Menghapus Data?"  class="btn btn-sm btn-danger">DELETE</button>
                                </td>
                            </tr>
                            @empty
