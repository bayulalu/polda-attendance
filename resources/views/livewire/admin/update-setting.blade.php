            ...
            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                ...
                <div class="card-body pt-5">
                    ...
                    <form id="kt_ecommerce_settings_general_form"
                        class="form fv-plugins-bootstrap5 fv-plugins-framework" wire:submit="update">
                        <!--begin::Input group-->
                        <!--end::Input group-->
                        <!--begin::Input group-->
                                ...
                                <div class="fv-row mb-5 fv-plugins-icon-container">
                                    ...
                                    <div class="">
                                        <label for="exampleFormControlInput1" class="required form-label">Jam
                                            Masuk</label>
                                        <input type="text" class="form-control" wire:model="time_arrival"
                                            id="kedatangan" />
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <div class="">
                                        <label for="exampleFormControlInput1" class="required form-label">Jam
                                            Pulang</label>
                                        <input type="text" class="form-control" wire:model="time_gohome"
                                            id="pulang" />
                                    </div>
